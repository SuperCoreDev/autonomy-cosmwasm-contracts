...
// -------------------------------------------------------------------------------------
// setup all contracts for Juno testnet
// -------------------------------------------------------------------------------------
export async function setupCommon(
    ...
    // await stakeAUTO2RegistryStake(wallet3, testnet.addresses.wallet3, registryStake, auto, 1);
...
async function setup(
    ...
    const autoTokenResult = await instantiateContract(
        ...
        cw20CodeId,
        {
            ...
            "initial_balances": [
                {
                    "address": testnet.addresses.wallet1,
                    "amount": "10000000000"
                },
                {
                ...
                {
                    "address": testnet.addresses.wallet3,
                    "amount": "10000000000"
                }
            ]   
        }
