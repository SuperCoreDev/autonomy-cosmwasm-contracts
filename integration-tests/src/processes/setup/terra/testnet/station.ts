...
async function setup(
    ...
    const fundsRouterResult = await instantiateContract(
        ...
        {
            "registry": registry,
            "reg_user_fee_veri_forwarder": testnet.contractConsts.reg_user_fee_veri_forwarder,
            "fund_denom": testnet.contractConsts.fundsRouterDenom,
        }
      );
    ...
    const timeConditionsResult = await instantiateContract(
        ...
        {
            "router_user_veri_forwarder": testnet.contractConsts.router_user_veri_forwarder,
        }
      );
