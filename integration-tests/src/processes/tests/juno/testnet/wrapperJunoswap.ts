...
export async function testExecuteWrapperJunoswap(
  ...
  // await walletAddLiquidity(wallet1, testnet.addresses.wallet1, tcw, tcwUjunoswap, "1000000", "1000000");
...
async function testWrapperSuccessSwap(
  ...
  const beforeTcw: any = await junod.queryContractSmart(tcw, {
    balance: {
      address: testnet.addresses.wallet2,
    }
  });
  ...
  const result: any = await wallet3_client.execute(testnet.addresses.wallet3, wrapperJunoSwap, {
      swap: {
        user: testnet.addresses.wallet2,
...
async function testWrapperNative2Cw20Token(
  ...
  const createReqResult = await wallet2_client.execute(testnet.addresses.wallet2, registryStake, {
    create_request: {
  ...
  }, "auto", undefined, [coin(parseInt(ujunox_amount) + parseInt("1000"), "ujunox")]);
  ...
  const beforeUjuno: Coin = await junod.getBalance(testnet.addresses.wallet3, "ujunox"); 
  ...
  const result: any = await wallet3_client.execute(testnet.addresses.wallet3, registryStake, {
      execute_request: {
        id: requestId,
      },
    }, "auto", undefined, [coin(ujunox_amount, "ujunox")]);
  ...
  const afterUjuno: Coin = await junod.getBalance(testnet.addresses.wallet3, "ujunox"); 
...
async function testWrapperCw20Token2Native(
  ...
  await wallet2_client.execute(testnet.addresses.wallet2, tcw, {
    increase_allowance: {
  ...
  }, "auto", undefined, [coin("1000", "ujunox")]);
  ...
  const beforeUjuno: Coin = await junod.getBalance(testnet.addresses.wallet2, "ujunox"); 
  const beforeUjunoBalance = beforeUjuno.amount;
  ...
  const afterUjuno: Coin = await junod.getBalance(testnet.addresses.wallet2, "ujunox"); 
  const afterUjunoBalance = afterUjuno.amount;
