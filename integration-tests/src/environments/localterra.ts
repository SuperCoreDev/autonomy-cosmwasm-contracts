...
import { setupCommon } from "../processes/setup/terra/localterra/common";
import { setupStation } from "../processes/setup/terra/localterra/station";
import { setupWrapperAstroport } from "../processes/setup/terra/localterra/wrapperAstroport";

import { testExecuteStation } from "../processes/tests/terra/localterra/station";
import { testExecuteWrapperAstroport } from "../processes/tests/terra/localterra/wrapperAstroport";
...
async function initializeStation() {
    ...
    auto = localterra.contracts.auto;
    registryStake = localterra.contracts.registryStake;
    fundsRouter = localterra.contracts.fundsRouter;
    timeConditions = localterra.contracts.timeConditions;
    counter = localterra.contracts.testCounter;
...
async function initializeWrapperAstroport() {
    ...
    auto = localterra.contracts.auto;
    registryStake = localterra.contracts.registryStake;
    tcw = localterra.contracts.tcw;
    tcwUlunaSwap = localterra.contracts.tcwUlunaSwap;
    tcw_auto_swap = localterra.contracts.tcwAutoSwap;

    wrapperAstroport = localterra.contracts.wrapperAstroport;
