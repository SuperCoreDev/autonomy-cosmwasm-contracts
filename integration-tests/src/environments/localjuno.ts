...
import { setupCommon } from "../processes/setup/juno/localjuno/common";
import { setupStation } from "../processes/setup/juno/localjuno/station";
import { setupWrapperJunoswap } from "../processes/setup/juno/localjuno/wrapperJunoswap";

import { testExecuteStation } from "../processes/tests/juno/localjuno/station";
import { testExecuteWrapperJunoswap } from "../processes/tests/juno/localjuno/wrapperJunoswap";
...
async function initializeStation() {
    ...
    auto = localjuno.contracts.auto;
    registryStake = localjuno.contracts.registryStake;
    fundsRouter = localjuno.contracts.fundsRouter;
    timeConditions = localjuno.contracts.timeConditions;
    counter = localjuno.contracts.testCounter;
...
async function initializeWrapperJunoSwap() {
    ...
    auto = localjuno.contracts.auto;
    registryStake = localjuno.contracts.registryStake;
    tcw = localjuno.contracts.tcw;
    tcwUcosmSwap = localjuno.contracts.tcwUcosmSwap;
    wrapperJunoswap = localjuno.contracts.wrapperJunoSwap;

    console.log(`Use ${chalk.cyan(auto)} as AUTO token`);
    console.log(`Use ${chalk.cyan(registryStake)} as RegistryStake`);
    console.log(`Use ${chalk.cyan(tcw)} as TCW(Test CW20 token)`);
    console.log(`Use ${chalk.cyan(tcwUcosmSwap)} as "TCW-ucsom" swap`);
